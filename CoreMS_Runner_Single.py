...
parser.add_argument('-i', '--input_file', required=True, help= "Specify the input file being run through CoreMS (Required).")
parser.add_argument('-d', '--input_dir', required=True, help="Input directory that contains relevant FTICR-MS files (Required).")
